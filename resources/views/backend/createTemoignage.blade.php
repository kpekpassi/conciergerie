    ...
    <div class="container-fluid br bg-white  p-0 shadow-sm" style="overflow: hidden;">
        <div class="px-4 py-1 bg-bou-claire">
            <div class="container-fluid text-left">
                <h6 class=" text-uppercase blockTitle" style="font-weight: bold;color: #fff;"> Nouveau témoignage</h6>
            </div>
        </div>
        <form  method="POST" action="{{route('enregistrer.temoignage')}}" enctype="multipart/form-data">
            @csrf
            <div class="container-fluid px-3 px-sm-5 py-2  text-left">

                <div class="row py-3 px-0 container-fluid mx-0">
                    <div class="col-12 mb-3 ">
                        <label for="nom" class="font-bold font-open mb-2">Nom & Prenoms<span style="color: red;">*</span></label>
                    ...
                    <div class="col-12 mb-3 ">
                        ...
                        <input type="text" required="" class="form-control br border-none  @error('fonction') is-invalid @enderror" autocomplete="fonction" name="fonction" id="fonction" value="{{old('fonction') }}" class="form-control">
                        @error('fonction')
                        <div class="invalid-feedback text-left" role="alert">
                            <strong>{{ $message }}</strong>
                        </div>
                    ...
                    <div class="col-12 mb-3 ">
                        ...
                        <textarea type="text" required="" placeholder="" class="form-control br border-none @error('description') is-invalid @enderror" autocomplete="description" name="description" id="contenu" cols="30" rows="2"> {{old('description')}}</textarea>
                        @error('description')
                        <div class="invalid-feedback text-left" role="alert">
                            <strong>{{ $message }}</strong>
                        </div>
